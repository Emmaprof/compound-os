        ...
        <div className="w-full max-w-[400px] mt-12 md:mt-0">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              {/* Web3 Wallet Injector - Fixed Button Proportions */}
                          ...
                          {(() => {
                            ...
                            return (
                              <div className="flex gap-2 w-full animate-in fade-in duration-300">
                                {/* LOCKED SQUARE CHAIN BUTTON */}
                                <button 
                                  onClick={openChainModal} 
                                  type="button" 
                                  className="shrink-0 w-[46px] h-[46px] flex items-center justify-center bg-[#050505] hover:bg-white/5 border border-white/10 rounded-xl transition-colors shadow-[inset_0_0_10px_rgba(255,255,255,0.02)]"
                                >
                                  {chain.hasIcon && (
                                ...
                                {/* EXPANDED WALLET ADDRESS BUTTON */}
                                <button 
